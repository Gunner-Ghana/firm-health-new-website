...
import { useBoardMembers } from '../../hooks/useMemberDB';
...
function Board() {
  ...
  const [setMemberRef, visibleMembers] = useMultipleScrollAnimation(boardMembers?.length || 7);
        ...
        <div className="content-section">
          ...
          {boardMembers && boardMembers.length > 0 ? (
            ...
            <div className="empty-state-message">
              <p>No board members have been added yet.</p>
            </div>
          )}
        </div>
      </section>
