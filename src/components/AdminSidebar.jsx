...
function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* Mobile overlay */}
      {isMobileOpen && <div className="sidebar-overlay" onClick={closeMobile}></div>}

      <aside className={`admin-sidebar ${isCollapsed ? 'collapsed' : ''} ${isMobileOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-header">
          <Link to="/" className="sidebar-logo">
            <img src={logo} alt="Firm Health Ghana" className="sidebar-logo-img" />
            {!isCollapsed && <span>Firm Health</span>}
          </Link>
